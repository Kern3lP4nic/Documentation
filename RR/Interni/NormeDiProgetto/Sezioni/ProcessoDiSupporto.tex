...
\item \textbf{Specifica Tecnica}: in questo documento verrà mostrata una progettazione ad alto livello, basata su \gl{diagrammi dei package} per la descrizione delle componenti, \gl{diagrammi di sequenza} per descrivere i casi d'uso e \gl{diagrammi di attività}. Verranno inoltre elencati i software che saranno utilizzati per la realizzazione del progetto;
